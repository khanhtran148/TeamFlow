# 06 — Domain Events & Realtime Architecture
...
| WorkItem.EstimationChanged | 4 | **High** | Yes |
...
| WorkItem.Rejected | 2 | **High** | Yes |
| WorkItem.NeedsClarificationFlagged | 2 | Medium | Yes |
